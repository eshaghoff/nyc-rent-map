#!/usr/bin/env python3
"""
S2: Dense grid (0.002°/0.003°), MEAN rent (instead of median), MIN_CELL_COUNT=2
"""
...
for (clat, clng, gs), lsts in grid_cells.items():
    ...
    # KEY DIFFERENCE: Use mean instead of median
...
# Neighbor median clamping (relaxed to >= 1 neighbor)
CLAMP_RADIUS = 0.015
...
# Write output
with open("/tmp/heat_points_s2_dense_mean.js", "w") as f:
